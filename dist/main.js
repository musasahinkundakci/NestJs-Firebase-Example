...
async function bootstrap() {
    ...
    const options = new swagger_1.DocumentBuilder().setTitle("Customer API").setDescription("For practicing firebase...").setVersion("1.0.0").addBearerAuth({ type: "http", scheme: "bearer", bearerFormat: "Token" }, "access-token").build();
